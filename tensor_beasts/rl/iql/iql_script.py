...
The helper functions are coded in the utils.py.py associated with this script.
...
from tensor_beasts.rl.iql.utils import (
    dump_video,
    log_metrics,
    make_collector,
    make_environment,
...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    # Create model
    model = make_conv_iql_model(cfg, train_env, eval_env, device)
