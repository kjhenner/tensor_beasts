...
| `sweep_report.py` | Reads a W&B sweep back as a table, paired differences at matched seeds, and axis marginals. Reads the old sweeps in the `tensor-beasts-rl` W&B project; their configs were deleted. |
